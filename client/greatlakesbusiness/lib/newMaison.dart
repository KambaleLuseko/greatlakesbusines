          ...
          child: Column(
            children: <Widget>[
              Container(
                ...
                child: Text("Cette page est en cours de construction, veuillez vous diriger a l'adresse ci-dessous\n\n http://192.168.43.246/greatlakesbusinness/"),
              ),
              ...
              Expanded(
                child: Container(
                  ...
                  child: InAppWebView(
                    initialUrl: "http://192.168.43.246/greatlakesbusinness/preview.php",
                    initialHeaders: {
